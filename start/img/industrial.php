...
$value=$_COOKIE['lastvisited'];
 setcookie("lastvisited", $value."industrial,", time() + (86400 * 30), "/"); 
 $test=$_COOKIE['lastvisited'];


		if(isset($_COOKIE['industrial']))
		{
			$value=$_COOKIE['industrial'];
			$visits=$value+1;
			
			setcookie("industrial",$visits);
		}
		else
		{
			setcookie("industrial","1");
		}
		...
		<div class="row">
			 ...
			 <hr>
			  <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
						<h3>Buy Now</h3>
						<p class="item-intro text-muted">Industrial space for mall/appartments</p>
                                <img class="img-responsive img-centered" src="img/industrial- 2.jpg" alt="">
